...
SELECT nombre, apellidos FROM usuarios WHERE YEAR(fecha) = 2019;/*YEAR ESTA FUNCION ME AGARRA TODOO LO DE FECHA O SEA APARTE DEL AÑO EL DIA Y EL MES TAMBIEN Y COMPARA SI HAY UN 2019*/
