...
if(isset($_POST)){
	...
	if(count($errores) == 0){//cuenta q no alla errores y entra a actualizar
		...
		if($isset_user['id'] == $usuario['id'] || empty($isset_user)){//si el id
            //del usuario identificado coincide con el id del usuario 
            //con ese email, entonces significa q es el mismo usuario
            //entonces podes colocarle ese email a este usuario,
            //o si no existiera ese email podes entonces agregarlo 
